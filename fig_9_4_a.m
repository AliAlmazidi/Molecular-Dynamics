...
bins = (0:interval_20:up)';


line = (0:0.1:1)';
lx = ones(1,11);
plot(lx,line,'k','LineWidth',2)
hold on
...
legend('|v(ititial)| = 1','T = 0-20','T = 20-40','T = 40-60')
